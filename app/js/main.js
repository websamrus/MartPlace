$(function() {
    ...
    $('.single').on('click', function() {
        $(this).children('.price__title').addClass('active');
        $(this).children('.price__text').addClass('active');
        $('.multi').children('.price__title').removeClass('active');
        $('.multi').children('.price__text').removeClass('active');
    });
    $('.multi').on('click', function() {
        $(this).children('.price__title').addClass('active');
        $(this).children('.price__text').addClass('active');
        $('.single').children('.price__title').removeClass('active');
        $('.single').children('.price__text').removeClass('active');
    });
